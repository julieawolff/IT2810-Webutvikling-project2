describe("Sorting functionality", () => {
  beforeEach("Set username and route from landing page to main page", () => {
    cy.window().then((win) => {
  ...
  it("should show relevant cocktail when sorting from A to Z", () => {
  ...
  it("should show relevant cocktail when sorting from Z to A", () => {
    cy.contains("Rating High-Low").click();
  ...
  it("should show decreasing rating when sorting from high to low", () => {
    cy.contains("Rating High-Low").click();
        ...
        cy.get('[data-testid="card-1"]')
          ...
          .then((rating1) => {
            cy.get('[data-testid="card-2"]')
              ...
              .invoke("text")
              .then((rating2) => {
                const r0 = parseFloat(rating0.replace(/[()]/g, ""));
                const r1 = parseFloat(rating1.replace(/[()]/g, ""));
                const r2 = parseFloat(rating2.replace(/[()]/g, ""));
  ...
  it("should show increasing rating when sorting from low to high", () => {
    cy.contains("Rating High-Low").click();
  ...
  it("should check that sorting works togheter with filtering", () => {
    //Sort on Low to High
    cy.contains("Rating High-Low").click();
    cy.contains("Rating Low-High").click();
  ...
  it("should check that sorting works togheter with search and filtering", () => {
    //Add search
